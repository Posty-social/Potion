/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5faeb96f6780c757e95ccd018aa34b5c)
// Runtime types generated with workerd@1.20260701.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: R2Bucket;
	DB: D1Database;
	SEND_EMAIL: SendEmail;
	R2_BUCKET_NAME: "potion-assets";
	BETTER_AUTH_SECRET: string;
	BETTER_AUTH_URL: string;
	APP_DOMAIN: string;
	TRUSTED_ORIGINS: string;
	PAGE_DOC: DurableObjectNamespace<import("./src/server").PageDoc>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "PageDoc";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_BUCKET_NAME" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "APP_DOMAIN" | "TRUSTED_ORIGINS">> {}
}
